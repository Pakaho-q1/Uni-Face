...
with immich_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_sdk.LibrariesApi(api_client)
    create_library_dto = immich_sdk.CreateLibraryDto() # CreateLibraryDto | 
...
with immich_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_sdk.LibrariesApi(api_client)
    id = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID | 
    validate_library_dto = immich_sdk.ValidateLibraryDto() # ValidateLibraryDto | 
