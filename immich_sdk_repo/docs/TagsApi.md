...
with immich_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_sdk.TagsApi(api_client)
    tag_bulk_assets_dto = immich_sdk.TagBulkAssetsDto() # TagBulkAssetsDto | 
...
with immich_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = immich_sdk.TagsApi(api_client)
    tag_create_dto = immich_sdk.TagCreateDto() # TagCreateDto | 
...
with immich_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = immich_sdk.TagsApi(api_client)
    tag_upsert_dto = immich_sdk.TagUpsertDto() # TagUpsertDto | 
