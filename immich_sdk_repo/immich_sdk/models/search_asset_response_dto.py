...
class SearchAssetResponseDto(BaseModel):
    ...
    """ # noqa: E501
    count: Annotated[int, Field(le=9007199254740991, strict=True, ge=0)] = Field(description="Number of assets in this page")
    facets: List[SearchFacetResponseDto]
    items: List[AssetResponseDto]
    next_cursor: Optional[StrictStr] = Field(description="Cursor for the next page of results", alias="nextCursor")
    next_page: Optional[StrictStr] = Field(description="Next page token", alias="nextPage")
    total: Annotated[int, Field(le=9007199254740991, strict=True, ge=0)] = Field(description="Total number of matching assets")
    __properties: ClassVar[List[str]] = ["count", "facets", "items", "nextCursor", "nextPage", "total"]
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.facets:
            for _item_facets in self.facets:
                _items.append(_item_facets.to_dict() if _item_facets is not None else None)
            _dict['facets'] = _items
