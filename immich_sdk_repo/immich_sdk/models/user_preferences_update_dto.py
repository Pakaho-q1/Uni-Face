...
class UserPreferencesUpdateDto(BaseModel):
    ...
    recently_added: Optional[RecentlyAddedUpdate] = Field(default=None, alias="recentlyAdded")
    shared_links: Optional[SharedLinksUpdate] = Field(default=None, alias="sharedLinks")
    tags: Optional[TagsUpdate] = None
    __properties: ClassVar[List[str]] = ["albums", "avatar", "cast", "download", "emailNotifications", "folders", "memories", "people", "purchase", "ratings", "recentlyAdded", "sharedLinks", "tags"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "albums": AlbumsUpdate.from_dict(obj["albums"]) if obj.get("albums") is not None else None,
            "avatar": AvatarUpdate.from_dict(obj["avatar"]) if obj.get("avatar") is not None else None,
            "cast": CastUpdate.from_dict(obj["cast"]) if obj.get("cast") is not None else None,
            ...
            "recentlyAdded": RecentlyAddedUpdate.from_dict(obj["recentlyAdded"]) if obj.get("recentlyAdded") is not None else None,
