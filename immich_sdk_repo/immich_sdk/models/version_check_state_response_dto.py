...
class VersionCheckStateResponseDto(BaseModel):
    ...
    """ # noqa: E501
    checked_at: Optional[StrictStr] = Field(description="Last check timestamp", alias="checkedAt")
    release_version: Optional[StrictStr] = Field(description="Release version", alias="releaseVersion")
