...
class PlacesResponseDto(BaseModel):
    ...
    PlacesResponseDto
    """ # noqa: E501
    admin1name: Optional[StrictStr] = Field(default=None, description="Administrative level 1 name (state/province)")
    admin2name: Optional[StrictStr] = Field(default=None, description="Administrative level 2 name (county/district)")
