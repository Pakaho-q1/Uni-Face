...
class ServerVersionHistoryResponseDto(BaseModel):
    ...
    """ # noqa: E501
    created_at: datetime = Field(description="When this version was first seen", alias="createdAt", json_schema_extra={"examples": ["2024-01-01T00:00:00Z"]})
    id: UUID = Field(description="Version history entry ID")
