...
class StatisticsSearchDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["albumIds", "city", "country", "createdAfter", "createdBefore", "description", "filter", "isEncoded", "isFavorite", "isMotion", "isNotInAlbum", "isOffline", "lensModel", "libraryId", "make", "model", "ocr", "personIds", "rating", "state", "tagIds", "takenAfter", "takenBefore", "trashedAfter", "trashedBefore", "type", "updatedAfter", "updatedBefore", "visibility"]
