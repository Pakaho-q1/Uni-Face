...
class RandomSearchDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["albumIds", "city", "country", "createdAfter", "createdBefore", "filter", "isEncoded", "isFavorite", "isMotion", "isNotInAlbum", "isOffline", "lensModel", "libraryId", "make", "model", "ocr", "personIds", "rating", "size", "state", "tagIds", "takenAfter", "takenBefore", "trashedAfter", "trashedBefore", "type", "updatedAfter", "updatedBefore", "visibility", "withDeleted", "withExif", "withPeople", "withStacked"]
