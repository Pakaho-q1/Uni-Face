...
class NotificationUpdateAllDto(BaseModel):
    ...
    """ # noqa: E501
    ids: Annotated[List[UUID], Field(min_length=1)] = Field(description="Notification IDs to update")
    read_at: Optional[datetime] = Field(default=None, description="Date when notifications were read", alias="readAt", json_schema_extra={"examples": ["2024-01-01T00:00:00Z"]})
