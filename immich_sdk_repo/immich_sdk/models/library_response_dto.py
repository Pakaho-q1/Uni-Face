...
class LibraryResponseDto(BaseModel):
    ...
    refreshed_at: Optional[datetime] = Field(description="Last refresh date", alias="refreshedAt", json_schema_extra={"examples": ["2024-01-01T00:00:00Z"]})
    ...
    @field_validator('refreshed_at', mode="before")
