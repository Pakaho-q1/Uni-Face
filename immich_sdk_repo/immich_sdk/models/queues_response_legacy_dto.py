...
class QueuesResponseLegacyDto(BaseModel):
    ...
    integrity_check: QueueResponseLegacyDto = Field(alias="integrityCheck")
    ...
    storage_template_migration: QueueResponseLegacyDto = Field(alias="storageTemplateMigration")
    ...
    __properties: ClassVar[List[str]] = ["backgroundTask", "backupDatabase", "duplicateDetection", "editor", "faceDetection", "facialRecognition", "integrityCheck", "library", "metadataExtraction", "migration", "notifications", "ocr", "search", "sidecar", "smartSearch", "storageTemplateMigration", "thumbnailGeneration", "videoConversion", "workflow"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of integrity_check
        if self.integrity_check:
            _dict['integrityCheck'] = self.integrity_check.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "backgroundTask": QueueResponseLegacyDto.from_dict(obj["backgroundTask"]) if obj.get("backgroundTask") is not None else None,
            "backupDatabase": QueueResponseLegacyDto.from_dict(obj["backupDatabase"]) if obj.get("backupDatabase") is not None else None,
            "duplicateDetection": QueueResponseLegacyDto.from_dict(obj["duplicateDetection"]) if obj.get("duplicateDetection") is not None else None,
            "editor": QueueResponseLegacyDto.from_dict(obj["editor"]) if obj.get("editor") is not None else None,
            "faceDetection": QueueResponseLegacyDto.from_dict(obj["faceDetection"]) if obj.get("faceDetection") is not None else None,
            "facialRecognition": QueueResponseLegacyDto.from_dict(obj["facialRecognition"]) if obj.get("facialRecognition") is not None else None,
            "integrityCheck": QueueResponseLegacyDto.from_dict(obj["integrityCheck"]) if obj.get("integrityCheck") is not None else None,
            "library": QueueResponseLegacyDto.from_dict(obj["library"]) if obj.get("library") is not None else None,
            "metadataExtraction": QueueResponseLegacyDto.from_dict(obj["metadataExtraction"]) if obj.get("metadataExtraction") is not None else None,
            "migration": QueueResponseLegacyDto.from_dict(obj["migration"]) if obj.get("migration") is not None else None,
            "notifications": QueueResponseLegacyDto.from_dict(obj["notifications"]) if obj.get("notifications") is not None else None,
            "ocr": QueueResponseLegacyDto.from_dict(obj["ocr"]) if obj.get("ocr") is not None else None,
            "search": QueueResponseLegacyDto.from_dict(obj["search"]) if obj.get("search") is not None else None,
            "sidecar": QueueResponseLegacyDto.from_dict(obj["sidecar"]) if obj.get("sidecar") is not None else None,
            "smartSearch": QueueResponseLegacyDto.from_dict(obj["smartSearch"]) if obj.get("smartSearch") is not None else None,
            "storageTemplateMigration": QueueResponseLegacyDto.from_dict(obj["storageTemplateMigration"]) if obj.get("storageTemplateMigration") is not None else None,
            "thumbnailGeneration": QueueResponseLegacyDto.from_dict(obj["thumbnailGeneration"]) if obj.get("thumbnailGeneration") is not None else None,
            "videoConversion": QueueResponseLegacyDto.from_dict(obj["videoConversion"]) if obj.get("videoConversion") is not None else None,
            "workflow": QueueResponseLegacyDto.from_dict(obj["workflow"]) if obj.get("workflow") is not None else None
        })
        return _obj
