...
class QueueStatusLegacyDto(BaseModel):
    ...
    """ # noqa: E501
    is_active: StrictBool = Field(description="Whether the queue is currently active (has running jobs)", alias="isActive")
    is_paused: StrictBool = Field(description="Whether the queue is paused", alias="isPaused")
