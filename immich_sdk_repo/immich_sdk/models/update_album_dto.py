...
class UpdateAlbumDto(BaseModel):
    ...
    UpdateAlbumDto
    """ # noqa: E501
    album_name: Optional[StrictStr] = Field(default=None, description="Album name", alias="albumName")
    album_thumbnail_asset_id: Optional[UUID] = Field(default=None, description="Album thumbnail asset ID", alias="albumThumbnailAssetId")
    description: Optional[StrictStr] = Field(default=None, description="Album description")
    is_activity_enabled: Optional[StrictBool] = Field(default=None, description="Enable activity feed", alias="isActivityEnabled")
