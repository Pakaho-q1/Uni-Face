...
class UserConfigDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ffmpeg", "image", "machineLearning", "map", "oauth", "passwordLogin", "reverseGeocoding", "server", "theme", "trash", "user"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ffmpeg": UserConfigFFmpegDto.from_dict(obj["ffmpeg"]) if obj.get("ffmpeg") is not None else None,
            "image": UserConfigImageDto.from_dict(obj["image"]) if obj.get("image") is not None else None,
            "machineLearning": UserConfigMachineLearningDto.from_dict(obj["machineLearning"]) if obj.get("machineLearning") is not None else None,
            "map": UserConfigMapDto.from_dict(obj["map"]) if obj.get("map") is not None else None,
            "oauth": UserConfigOAuthDto.from_dict(obj["oauth"]) if obj.get("oauth") is not None else None,
            "passwordLogin": UserConfigPasswordLoginDto.from_dict(obj["passwordLogin"]) if obj.get("passwordLogin") is not None else None,
            "reverseGeocoding": UserConfigReverseGeocodingDto.from_dict(obj["reverseGeocoding"]) if obj.get("reverseGeocoding") is not None else None,
            "server": UserConfigServerDto.from_dict(obj["server"]) if obj.get("server") is not None else None,
            "theme": UserConfigThemeDto.from_dict(obj["theme"]) if obj.get("theme") is not None else None,
            "trash": UserConfigTrashDto.from_dict(obj["trash"]) if obj.get("trash") is not None else None,
            "user": UserConfigUserDto.from_dict(obj["user"]) if obj.get("user") is not None else None
        })
        return _obj
