...
class SessionCreateDto(BaseModel):
    ...
    SessionCreateDto
    """ # noqa: E501
    device_os: Optional[StrictStr] = Field(default=None, description="Device OS", alias="deviceOS")
    device_type: Optional[StrictStr] = Field(default=None, description="Device type", alias="deviceType")
    duration: Optional[Annotated[int, Field(le=9007199254740991, strict=True, ge=1)]] = Field(default=None, description="Session duration in seconds")
