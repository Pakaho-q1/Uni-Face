...
class DownloadArchiveDto(BaseModel):
    ...
    DownloadArchiveDto
    """ # noqa: E501
    archive_name: Optional[StrictStr] = Field(default=None, description="The name of the archive to download, without extension", alias="archiveName")
    ...
    __properties: ClassVar[List[str]] = ["archiveName", "assetIds", "edited"]
