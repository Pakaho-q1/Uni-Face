...
class SyncMemoryV1(BaseModel):
    ...
    SyncMemoryV1
    """ # noqa: E501
    created_at: datetime = Field(description="Created at", alias="createdAt", json_schema_extra={"examples": ["2024-01-01T00:00:00Z"]})
    ...
    hide_at: Optional[datetime] = Field(description="Hide at", alias="hideAt", json_schema_extra={"examples": ["2024-01-01T00:00:00Z"]})
    id: UUID = Field(description="Memory ID")
    is_saved: StrictBool = Field(description="Is saved", alias="isSaved")
    memory_at: datetime = Field(description="Memory at", alias="memoryAt", json_schema_extra={"examples": ["2024-01-01T00:00:00Z"]})
    owner_id: UUID = Field(description="Owner ID", alias="ownerId")
    seen_at: Optional[datetime] = Field(description="Seen at", alias="seenAt", json_schema_extra={"examples": ["2024-01-01T00:00:00Z"]})
    show_at: Optional[datetime] = Field(description="Show at", alias="showAt", json_schema_extra={"examples": ["2024-01-01T00:00:00Z"]})
    type: MemoryType
    updated_at: datetime = Field(description="Updated at", alias="updatedAt", json_schema_extra={"examples": ["2024-01-01T00:00:00Z"]})
    __properties: ClassVar[List[str]] = ["createdAt", "data", "deletedAt", "hideAt", "id", "isSaved", "memoryAt", "ownerId", "seenAt", "showAt", "type", "updatedAt"]
