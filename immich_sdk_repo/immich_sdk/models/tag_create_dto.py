...
class TagCreateDto(BaseModel):
    ...
    TagCreateDto
    """ # noqa: E501
    color: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Tag color (hex)")
    name: Annotated[str, Field(strict=True)] = Field(description="Tag name")
    parent_id: Optional[UUID] = Field(default=None, description="Parent tag ID", alias="parentId")
