...
class WorkflowResponseDto(BaseModel):
    ...
    logging: StrictBool = Field(description="Workflow logs run results")
    ...
    __properties: ClassVar[List[str]] = ["createdAt", "description", "enabled", "id", "logging", "name", "steps", "trigger", "updatedAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "steps": [WorkflowStepDto.from_dict(_item) for _item in obj["steps"]] if obj.get("steps") is not None else None,
