...
class SmartSearchDto(BaseModel):
    ...
    language: Optional[StrictStr] = Field(default=None, description="Search language code")
    ...
    query: Optional[StrictStr] = Field(default=None, description="Natural language search query")
    query_asset_id: Optional[UUID] = Field(default=None, description="Asset ID to use as search reference", alias="queryAssetId")
    ...
    size: Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]] = Field(default=100, description="Number of results to return")
    ...
    __properties: ClassVar[List[str]] = ["albumIds", "city", "country", "createdAfter", "createdBefore", "filter", "isEncoded", "isFavorite", "isMotion", "isNotInAlbum", "isOffline", "language", "lensModel", "libraryId", "make", "model", "ocr", "page", "personIds", "query", "queryAssetId", "rating", "size", "state", "tagIds", "takenAfter", "takenBefore", "trashedAfter", "trashedBefore", "type", "updatedAfter", "updatedBefore", "visibility", "withDeleted", "withExif"]
    ...
    @field_validator('query_asset_id', mode="before")
    def query_asset_id_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
