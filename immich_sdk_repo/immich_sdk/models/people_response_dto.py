...
class PeopleResponseDto(BaseModel):
    ...
    People response
    """ # noqa: E501
    has_next_page: Optional[StrictBool] = Field(default=None, description="Whether there are more pages", alias="hasNextPage")
    hidden: Annotated[int, Field(le=9007199254740991, strict=True, ge=0)] = Field(description="Number of hidden people")
    people: List[PersonResponseDto]
    total: Annotated[int, Field(le=9007199254740991, strict=True, ge=0)] = Field(description="Total number of people")
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.people:
            for _item_people in self.people:
                _items.append(_item_people.to_dict() if _item_people is not None else None)
            _dict['people'] = _items
        return _dict
