...
class SharedLinkResponseDto(BaseModel):
    ...
    allow_download: StrictBool = Field(description="Allow downloads", alias="allowDownload")
    ...
    expires_at: Optional[datetime] = Field(description="Expiration date", alias="expiresAt", json_schema_extra={"examples": ["2024-01-01T00:00:00Z"]})
    ...
    __properties: ClassVar[List[str]] = ["album", "allowDownload", "allowUpload", "assets", "createdAt", "description", "expiresAt", "id", "key", "password", "showMetadata", "slug", "type", "userId"]
