...
class WorkflowShareResponseDto(BaseModel):
    ...
    steps: List[WorkflowShareStepDto] = Field(description="Workflow steps")
    trigger: WorkflowTrigger
    __properties: ClassVar[List[str]] = ["description", "name", "steps", "trigger"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "steps": [WorkflowShareStepDto.from_dict(_item) for _item in obj["steps"]] if obj.get("steps") is not None else None,
