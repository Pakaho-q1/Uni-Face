...
class PluginResponseDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["author", "createdAt", "description", "id", "methods", "name", "title", "updatedAt", "version"]
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.methods:
            for _item_methods in self.methods:
                _items.append(_item_methods.to_dict() if _item_methods is not None else None)
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "methods": [PluginMethodResponseDto.from_dict(_item) for _item in obj["methods"]] if obj.get("methods") is not None else None,
            "name": obj.get("name"),
            "title": obj.get("title"),
