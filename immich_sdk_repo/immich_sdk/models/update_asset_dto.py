...
class UpdateAssetDto(BaseModel):
    ...
    live_photo_video_id: Optional[UUID] = Field(default=None, description="Live photo video ID", alias="livePhotoVideoId")
    ...
    __properties: ClassVar[List[str]] = ["dateTimeOriginal", "description", "isFavorite", "latitude", "livePhotoVideoId", "longitude", "rating", "visibility"]
