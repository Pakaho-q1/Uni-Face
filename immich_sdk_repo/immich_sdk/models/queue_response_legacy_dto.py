...
class QueueResponseLegacyDto(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "jobCounts": QueueStatisticsDto.from_dict(obj["jobCounts"]) if obj.get("jobCounts") is not None else None,
            "queueStatus": QueueStatusLegacyDto.from_dict(obj["queueStatus"]) if obj.get("queueStatus") is not None else None
        })
        return _obj
