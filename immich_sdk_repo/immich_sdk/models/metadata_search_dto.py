...
class MetadataSearchDto(BaseModel):
    ...
    created_after: Optional[datetime] = Field(default=None, description="Filter by creation date (after)", alias="createdAfter", json_schema_extra={"examples": ["2024-01-01T00:00:00Z"]})
    created_before: Optional[datetime] = Field(default=None, description="Filter by creation date (before)", alias="createdBefore", json_schema_extra={"examples": ["2024-01-01T00:00:00Z"]})
    cursor: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, description="Cursor for the next page of results")
    ...
    order_by: Optional[SearchOrder] = Field(default=None, alias="orderBy")
    ...
    size: Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]] = Field(default=250, description="Number of results to return")
    ...
    taken_after: Optional[datetime] = Field(default=None, description="Filter by taken date (after)", alias="takenAfter", json_schema_extra={"examples": ["2024-01-01T00:00:00Z"]})
    taken_before: Optional[datetime] = Field(default=None, description="Filter by taken date (before)", alias="takenBefore", json_schema_extra={"examples": ["2024-01-01T00:00:00Z"]})
    thumbnail_path: Optional[StrictStr] = Field(default=None, description="Filter by thumbnail file path", alias="thumbnailPath")
    trashed_after: Optional[datetime] = Field(default=None, description="Filter by trash date (after)", alias="trashedAfter", json_schema_extra={"examples": ["2024-01-01T00:00:00Z"]})
    trashed_before: Optional[datetime] = Field(default=None, description="Filter by trash date (before)", alias="trashedBefore", json_schema_extra={"examples": ["2024-01-01T00:00:00Z"]})
    type: Optional[AssetTypeEnum] = None
    updated_after: Optional[datetime] = Field(default=None, description="Filter by update date (after)", alias="updatedAfter", json_schema_extra={"examples": ["2024-01-01T00:00:00Z"]})
    updated_before: Optional[datetime] = Field(default=None, description="Filter by update date (before)", alias="updatedBefore", json_schema_extra={"examples": ["2024-01-01T00:00:00Z"]})
    visibility: Optional[AssetVisibility] = None
    with_deleted: Optional[StrictBool] = Field(default=None, description="Include deleted assets", alias="withDeleted")
    with_exif: Optional[StrictBool] = Field(default=None, description="Include EXIF data in response", alias="withExif")
    with_people: Optional[StrictBool] = Field(default=None, description="Include people data in response", alias="withPeople")
    with_stacked: Optional[StrictBool] = Field(default=None, description="Include stacked assets", alias="withStacked")
    __properties: ClassVar[List[str]] = ["albumIds", "checksum", "city", "country", "createdAfter", "createdBefore", "cursor", "description", "encodedVideoPath", "filter", "id", "isEncoded", "isFavorite", "isMotion", "isNotInAlbum", "isOffline", "lensModel", "libraryId", "make", "model", "ocr", "order", "orderBy", "originalFileName", "originalPath", "page", "personIds", "previewPath", "rating", "size", "state", "tagIds", "takenAfter", "takenBefore", "thumbnailPath", "trashedAfter", "trashedBefore", "type", "updatedAfter", "updatedBefore", "visibility", "withDeleted", "withExif", "withPeople", "withStacked"]
    ...
    def created_after_validate_regular_expression(cls, value):
        ...
        if isinstance(value, str) and not re.match(r"^(?:(?:\d\d[2468][048]|\d\d[13579][26]|\d\d0[48]|[02468][048]00|[13579][26]00)-02-29|\d{4}-(?:(?:0[13578]|1[02])-(?:0[1-9]|[12]\d|3[01])|(?:0[469]|11)-(?:0[1-9]|[12]\d|30)|(?:02)-(?:0[1-9]|1\d|2[0-8])))T(?:(?:[01]\d|2[0-3]):[0-5]\d(?::[0-5]\d(?:\.\d+)?)?(?:Z|([+-](?:[01]\d|2[0-3]):[0-5]\d)))$", value):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ocr": obj.get("ocr"),
            "order": obj.get("order"),
            "orderBy": SearchOrder.from_dict(obj["orderBy"]) if obj.get("orderBy") is not None else None,
            ...
            "size": obj.get("size") if obj.get("size") is not None else 250,
            "state": obj.get("state"),
