...
class AdminConfigStorageTemplateDto(BaseModel):
    """
    AdminConfigStorageTemplateDto
    """ # noqa: E501
    enabled: StrictBool = Field(description="Enabled")
    hash_verification_enabled: StrictBool = Field(description="Hash verification enabled", alias="hashVerificationEnabled")
