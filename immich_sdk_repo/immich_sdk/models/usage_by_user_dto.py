...
class UsageByUserDto(BaseModel):
    ...
    quota_size_in_bytes: Optional[Annotated[int, Field(le=9007199254740991, strict=True, ge=-9007199254740991)]] = Field(description="User quota size in bytes (null if unlimited)", alias="quotaSizeInBytes")
