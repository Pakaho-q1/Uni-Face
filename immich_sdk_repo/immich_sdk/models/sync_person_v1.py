...
class SyncPersonV1(BaseModel):
    ...
    SyncPersonV1
    """ # noqa: E501
    birth_date: Optional[datetime] = Field(description="Birth date", alias="birthDate", json_schema_extra={"examples": ["2024-01-01T00:00:00Z"]})
    ...
    face_asset_id: Optional[StrictStr] = Field(description="Face asset ID", alias="faceAssetId")
    ...
    __properties: ClassVar[List[str]] = ["birthDate", "color", "createdAt", "faceAssetId", "id", "isFavorite", "isHidden", "name", "ownerId", "updatedAt"]
