...
class OAuthConfigDto(BaseModel):
    ...
    OAuthConfigDto
    """ # noqa: E501
    code_challenge: Optional[StrictStr] = Field(default=None, description="OAuth code challenge (PKCE)", alias="codeChallenge")
    redirect_uri: StrictStr = Field(description="OAuth redirect URI", alias="redirectUri")
