...
class SyncAssetOcrDeleteV1(BaseModel):
    ...
    """ # noqa: E501
    asset_id: StrictStr = Field(description="Original asset ID of the deleted OCR entry", alias="assetId")
    deleted_at: datetime = Field(description="Timestamp when the OCR entry was deleted", alias="deletedAt", json_schema_extra={"examples": ["2024-01-01T00:00:00Z"]})
