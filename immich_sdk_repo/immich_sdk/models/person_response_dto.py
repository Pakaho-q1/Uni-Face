...
class PersonResponseDto(BaseModel):
    ...
    PersonResponseDto
    """ # noqa: E501
    birth_date: Optional[date] = Field(description="Person date of birth", alias="birthDate")
    color: Optional[StrictStr] = Field(default=None, description="Person color (hex)")
    id: UUID = Field(description="Person ID")
    is_favorite: Optional[StrictBool] = Field(default=None, description="Is favorite", alias="isFavorite")
    is_hidden: StrictBool = Field(description="Is hidden", alias="isHidden")
    name: StrictStr = Field(description="Person name")
    thumbnail_path: StrictStr = Field(description="Thumbnail path", alias="thumbnailPath")
    updated_at: Optional[datetime] = Field(default=None, description="Last update date", alias="updatedAt")
