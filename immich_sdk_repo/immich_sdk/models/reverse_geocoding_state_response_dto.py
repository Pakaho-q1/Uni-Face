...
class ReverseGeocodingStateResponseDto(BaseModel):
    ...
    """ # noqa: E501
    last_import_file_name: Optional[StrictStr] = Field(description="Last import file name", alias="lastImportFileName")
    last_update: Optional[StrictStr] = Field(description="Last update timestamp", alias="lastUpdate")
