...
class SearchAlbumResponseDto(BaseModel):
    ...
    """ # noqa: E501
    count: Annotated[int, Field(le=9007199254740991, strict=True, ge=0)] = Field(description="Number of albums in this page")
    facets: List[SearchFacetResponseDto]
    items: List[AlbumResponseDto]
    total: Annotated[int, Field(le=9007199254740991, strict=True, ge=0)] = Field(description="Total number of matching albums")
