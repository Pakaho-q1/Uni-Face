...
class AdminConfigTemplateEmailsDto(BaseModel):
    """
    AdminConfigTemplateEmailsDto
    """ # noqa: E501
    album_invite_template: StrictStr = Field(description="Album invite template", alias="albumInviteTemplate")
    album_update_template: StrictStr = Field(description="Album update template", alias="albumUpdateTemplate")
    welcome_template: StrictStr = Field(description="Welcome template", alias="welcomeTemplate")
