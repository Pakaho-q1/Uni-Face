...
class ChangePasswordDto(BaseModel):
    ...
    new_password: Annotated[str, Field(min_length=8, strict=True)] = Field(description="New password (min 8 characters)", alias="newPassword", json_schema_extra={"examples": ["password"]})
    password: StrictStr = Field(description="Current password", json_schema_extra={"examples": ["password"]})
