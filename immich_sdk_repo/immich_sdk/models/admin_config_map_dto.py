...
class AdminConfigMapDto(BaseModel):
    """
    AdminConfigMapDto
    """ # noqa: E501
    dark_style: StrictStr = Field(description="Dark map style URL", alias="darkStyle")
    enabled: StrictBool = Field(description="Enabled")
    light_style: StrictStr = Field(description="Light map style URL", alias="lightStyle")
