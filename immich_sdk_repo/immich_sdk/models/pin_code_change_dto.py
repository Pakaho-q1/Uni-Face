...
class PinCodeChangeDto(BaseModel):
    ...
    PinCodeChangeDto
    """ # noqa: E501
    new_pin_code: Annotated[str, Field(strict=True)] = Field(description="New PIN code (4-6 digits)", alias="newPinCode")
    password: Optional[StrictStr] = Field(default=None, description="User password (required if PIN code is not provided)", json_schema_extra={"examples": ["password"]})
    pin_code: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="New PIN code (4-6 digits)", alias="pinCode", json_schema_extra={"examples": ["123456"]})
