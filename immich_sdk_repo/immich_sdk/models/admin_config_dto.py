...
class AdminConfigDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["backup", "ffmpeg", "image", "integrityChecks", "job", "library", "logging", "machineLearning", "map", "metadata", "newVersionCheck", "nightlyTasks", "notifications", "oauth", "passwordLogin", "reverseGeocoding", "server", "storageTemplate", "templates", "theme", "trash", "user"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "backup": AdminConfigBackupsDto.from_dict(obj["backup"]) if obj.get("backup") is not None else None,
            "ffmpeg": AdminConfigFFmpegDto.from_dict(obj["ffmpeg"]) if obj.get("ffmpeg") is not None else None,
            "image": AdminConfigImageDto.from_dict(obj["image"]) if obj.get("image") is not None else None,
            "integrityChecks": AdminConfigIntegrityChecksDto.from_dict(obj["integrityChecks"]) if obj.get("integrityChecks") is not None else None,
            "job": AdminConfigJobDto.from_dict(obj["job"]) if obj.get("job") is not None else None,
            "library": AdminConfigLibraryDto.from_dict(obj["library"]) if obj.get("library") is not None else None,
            "logging": AdminConfigLoggingDto.from_dict(obj["logging"]) if obj.get("logging") is not None else None,
            "machineLearning": AdminConfigMachineLearningDto.from_dict(obj["machineLearning"]) if obj.get("machineLearning") is not None else None,
            "map": AdminConfigMapDto.from_dict(obj["map"]) if obj.get("map") is not None else None,
            "metadata": AdminConfigMetadataDto.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
            "newVersionCheck": AdminConfigNewVersionCheckDto.from_dict(obj["newVersionCheck"]) if obj.get("newVersionCheck") is not None else None,
            "nightlyTasks": AdminConfigNightlyTasksDto.from_dict(obj["nightlyTasks"]) if obj.get("nightlyTasks") is not None else None,
            "notifications": AdminConfigNotificationsDto.from_dict(obj["notifications"]) if obj.get("notifications") is not None else None,
            "oauth": AdminConfigOAuthDto.from_dict(obj["oauth"]) if obj.get("oauth") is not None else None,
            "passwordLogin": AdminConfigPasswordLoginDto.from_dict(obj["passwordLogin"]) if obj.get("passwordLogin") is not None else None,
            "reverseGeocoding": AdminConfigReverseGeocodingDto.from_dict(obj["reverseGeocoding"]) if obj.get("reverseGeocoding") is not None else None,
            "server": AdminConfigServerDto.from_dict(obj["server"]) if obj.get("server") is not None else None,
            "storageTemplate": AdminConfigStorageTemplateDto.from_dict(obj["storageTemplate"]) if obj.get("storageTemplate") is not None else None,
            "templates": AdminConfigTemplatesDto.from_dict(obj["templates"]) if obj.get("templates") is not None else None,
            "theme": AdminConfigThemeDto.from_dict(obj["theme"]) if obj.get("theme") is not None else None,
            "trash": AdminConfigTrashDto.from_dict(obj["trash"]) if obj.get("trash") is not None else None,
            "user": AdminConfigUserDto.from_dict(obj["user"]) if obj.get("user") is not None else None
        })
        return _obj
