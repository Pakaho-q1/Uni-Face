...
class AdminConfigSmtpDto(BaseModel):
    """
    AdminConfigSmtpDto
    """ # noqa: E501
    enabled: StrictBool = Field(description="Whether SMTP email notifications are enabled")
    var_from: StrictStr = Field(description="Email address to send from", alias="from")
    reply_to: StrictStr = Field(description="Email address for replies", alias="replyTo")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "transport": AdminConfigSmtpTransportDto.from_dict(obj["transport"]) if obj.get("transport") is not None else None
        })
        return _obj
