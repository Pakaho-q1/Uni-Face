...
class UserLicense(BaseModel):
    ...
    UserLicense
    """ # noqa: E501
    activated_at: datetime = Field(description="Activation date", alias="activatedAt", json_schema_extra={"examples": ["2024-01-01T00:00:00Z"]})
    ...
    def license_key_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if isinstance(value, str) and not re.match(r"^IM(SV|CL)(-[\dA-Za-z]{4}){8}$", value):
