...
class MemoriesUpdate(BaseModel):
    ...
    sidebar_web: Optional[StrictBool] = Field(default=None, description="Whether memories appear in web sidebar", alias="sidebarWeb")
    __properties: ClassVar[List[str]] = ["duration", "enabled", "sidebarWeb"]
