...
class WorkflowUpdateDto(BaseModel):
    ...
    logging: Optional[StrictBool] = Field(default=None, description="Workflow logs run results")
    name: Optional[StrictStr] = Field(default=None, description="Workflow name")
    steps: Optional[List[WorkflowStepDto]] = None
    trigger: Optional[WorkflowTrigger] = None
    __properties: ClassVar[List[str]] = ["description", "enabled", "logging", "name", "steps", "trigger"]
