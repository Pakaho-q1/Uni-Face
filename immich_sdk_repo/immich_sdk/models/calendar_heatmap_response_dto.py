...
class CalendarHeatmapResponseDto(BaseModel):
    ...
    """ # noqa: E501
    var_from: StrictStr = Field(description="Start date in UTC", alias="from", json_schema_extra={"examples": ["2024-01-01"]})
    series: List[CalendarHeatmapResponseDtoSeriesInner]
    to: StrictStr = Field(description="End date in UTC", json_schema_extra={"examples": ["2024-12-31"]})
