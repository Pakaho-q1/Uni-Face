...
class ServerAboutResponseDto(BaseModel):
    ...
    build_image: Optional[StrictStr] = Field(default=None, description="Build image name", alias="buildImage")
    build_image_url: Optional[StrictStr] = Field(default=None, description="Build image URL", alias="buildImageUrl")
    build_url: Optional[StrictStr] = Field(default=None, description="Build URL", alias="buildUrl")
    ...
    imagemagick: Optional[StrictStr] = Field(default=None, description="ImageMagick version")
    ...
    repository_url: Optional[StrictStr] = Field(default=None, description="Repository URL", alias="repositoryUrl")
    source_commit: Optional[StrictStr] = Field(default=None, description="Source commit hash", alias="sourceCommit")
    source_ref: Optional[StrictStr] = Field(default=None, description="Source reference (branch/tag)", alias="sourceRef")
    source_url: Optional[StrictStr] = Field(default=None, description="Source URL", alias="sourceUrl")
    third_party_bug_feature_url: Optional[StrictStr] = Field(default=None, description="Third-party bug/feature URL", alias="thirdPartyBugFeatureUrl")
    third_party_documentation_url: Optional[StrictStr] = Field(default=None, description="Third-party documentation URL", alias="thirdPartyDocumentationUrl")
    third_party_source_url: Optional[StrictStr] = Field(default=None, description="Third-party source URL", alias="thirdPartySourceUrl")
    third_party_support_url: Optional[StrictStr] = Field(default=None, description="Third-party support URL", alias="thirdPartySupportUrl")
    version: StrictStr = Field(description="Server version")
    version_url: StrictStr = Field(description="URL to version information", alias="versionUrl")
