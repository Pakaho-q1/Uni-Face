...
class UserPreferencesResponseDto(BaseModel):
    ...
    recently_added: RecentlyAddedResponse = Field(alias="recentlyAdded")
    shared_links: SharedLinksResponse = Field(alias="sharedLinks")
    tags: TagsResponse
    __properties: ClassVar[List[str]] = ["albums", "cast", "download", "emailNotifications", "folders", "memories", "people", "purchase", "ratings", "recentlyAdded", "sharedLinks", "tags"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of recently_added
        if self.recently_added:
            _dict['recentlyAdded'] = self.recently_added.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "albums": AlbumsResponse.from_dict(obj["albums"]) if obj.get("albums") is not None else None,
            "cast": CastResponse.from_dict(obj["cast"]) if obj.get("cast") is not None else None,
            ...
            "recentlyAdded": RecentlyAddedResponse.from_dict(obj["recentlyAdded"]) if obj.get("recentlyAdded") is not None else None,
