...
class PublicConfigDto(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "oauth": PublicConfigOAuthDto.from_dict(obj["oauth"]) if obj.get("oauth") is not None else None,
            "passwordLogin": PublicConfigPasswordLoginDto.from_dict(obj["passwordLogin"]) if obj.get("passwordLogin") is not None else None,
            "server": PublicConfigServerDto.from_dict(obj["server"]) if obj.get("server") is not None else None,
            "theme": PublicConfigThemeDto.from_dict(obj["theme"]) if obj.get("theme") is not None else None
        })
        return _obj
