...
class DuplicateResolveGroupDto(BaseModel):
    ...
    keep_asset_ids: List[UUID] = Field(description="Asset IDs to keep", alias="keepAssetIds")
    trash_asset_ids: List[UUID] = Field(description="Asset IDs to trash or delete", alias="trashAssetIds")
