...
class ValidateLibraryResponseDto(BaseModel):
    ...
    """ # noqa: E501
    import_paths: Optional[List[ValidateLibraryImportPathResponseDto]] = Field(default=None, description="Validation results for import paths", alias="importPaths")
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.import_paths:
            for _item_import_paths in self.import_paths:
                _items.append(_item_import_paths.to_dict() if _item_import_paths is not None else None)
