        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.album_users:
            for _item_album_users in self.album_users:
                _items.append(_item_album_users.to_dict() if _item_album_users is not None else None)
        ...
        if self.contributor_counts:
            for _item_contributor_counts in self.contributor_counts:
                _items.append(_item_contributor_counts.to_dict() if _item_contributor_counts is not None else None)
