...
from immich_sdk.configuration import Configuration
from immich_sdk.api_response import ApiResponse, T as ApiResponseT
import immich_sdk.models
from immich_sdk import rest
from immich_sdk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(immich_sdk.models, klass)
