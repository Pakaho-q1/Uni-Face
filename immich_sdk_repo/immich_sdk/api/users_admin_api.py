...
class UsersAdminApi:
    ...
    def get_user_calendar_heatmap_admin(
        self,
        id: UUID,
        var_from: Annotated[Optional[date], Field(description="Start date in UTC")] = None,
        to: Annotated[Optional[date], Field(description="End date in UTC")] = None,
        type: Optional[CalendarHeatmapType] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: UUID
        :param var_from: Start date in UTC
        :type var_from: date
        :param to: End date in UTC
        :type to: date
        :param type:
        :type type: CalendarHeatmapType
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._get_user_calendar_heatmap_admin_serialize(
            id=id,
            var_from=var_from,
            to=to,
            type=type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CalendarHeatmapResponseDto",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def get_user_calendar_heatmap_admin_with_http_info(
        self,
        id: UUID,
        var_from: Annotated[Optional[date], Field(description="Start date in UTC")] = None,
        to: Annotated[Optional[date], Field(description="End date in UTC")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CalendarHeatmapResponseDto]:
        """Retrieve calendar heatmap activity
    ...
    @validate_call
    def get_user_calendar_heatmap_admin_without_preload_content(
        self,
        id: UUID,
        var_from: Annotated[Optional[date], Field(description="Start date in UTC")] = None,
        to: Annotated[Optional[date], Field(description="End date in UTC")] = None,
    ...
    def _get_user_calendar_heatmap_admin_serialize(
        self,
        id,
        var_from,
        to,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/admin/users/{id}/calendar-heatmap',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_user_sessions_admin_with_http_info(
        self,
        id: UUID,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_user_sessions_admin_without_preload_content(
        self,
        id: UUID,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_user_statistics_admin_with_http_info(
        self,
        id: UUID,
        is_favorite: Annotated[Optional[StrictBool], Field(description="Filter by favorite status")] = None,
        is_trashed: Annotated[Optional[StrictBool], Field(description="Filter by trash status")] = None,
    ...
    @validate_call
    def get_user_statistics_admin_without_preload_content(
        self,
        id: UUID,
        is_favorite: Annotated[Optional[StrictBool], Field(description="Filter by favorite status")] = None,
        is_trashed: Annotated[Optional[StrictBool], Field(description="Filter by trash status")] = None,
    ...
    def search_users_admin(
        ...
        with_deleted: Annotated[Optional[StrictBool], Field(description="Include deleted users")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def update_user_preferences_admin(
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("PUT /admin/users/{id}/preferences is deprecated.", DeprecationWarning)
