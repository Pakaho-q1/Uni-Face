...
class NotificationsAdminApi:
    ...
    @validate_call
    def get_notification_template_admin_with_http_info(
        self,
        name: StrictStr,
        template_dto: TemplateDto,
        _request_timeout: Union[
    ...
    @validate_call
    def get_notification_template_admin_without_preload_content(
        self,
        name: StrictStr,
        template_dto: TemplateDto,
        _request_timeout: Union[
    ...
    def send_test_email_admin(
        self,
        admin_config_smtp_dto: AdminConfigSmtpDto,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param admin_config_smtp_dto: (required)
        :type admin_config_smtp_dto: AdminConfigSmtpDto
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._send_test_email_admin_serialize(
            admin_config_smtp_dto=admin_config_smtp_dto,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def send_test_email_admin_with_http_info(
        self,
        admin_config_smtp_dto: AdminConfigSmtpDto,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def send_test_email_admin_without_preload_content(
        self,
        admin_config_smtp_dto: AdminConfigSmtpDto,
        _request_timeout: Union[
            None,
    ...
    def _send_test_email_admin_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if admin_config_smtp_dto is not None:
            _body_params = admin_config_smtp_dto
