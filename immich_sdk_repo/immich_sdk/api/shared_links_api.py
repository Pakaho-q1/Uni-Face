...
class SharedLinksApi:
    ...
    def get_all_shared_links(
        self,
        album_id: Annotated[Optional[UUID], Field(description="Filter by album ID")] = None,
        id: Annotated[Optional[UUID], Field(description="Filter by shared link ID")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def shared_link_login(
        ...
        :param shared_link_login_dto: (required)
        :type shared_link_login_dto: SharedLinkLoginDto
        :param key:
        :type key: str
        :param slug:
        :type slug: str
        ...
        _param = self._shared_link_login_serialize(
            shared_link_login_dto=shared_link_login_dto,
            key=key,
            slug=slug,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def shared_link_login_with_http_info(
        self,
        shared_link_login_dto: SharedLinkLoginDto,
        key: Optional[StrictStr] = None,
        slug: Optional[StrictStr] = None,
    ...
    @validate_call
    def shared_link_login_without_preload_content(
        self,
        shared_link_login_dto: SharedLinkLoginDto,
        key: Optional[StrictStr] = None,
        slug: Optional[StrictStr] = None,
    ...
    def _shared_link_login_serialize(
        self,
        shared_link_login_dto,
        key,
        slug,
        _request_auth,
        _content_type,
        ...
        # process the form parameters
        # process the body parameter
        if shared_link_login_dto is not None:
            _body_params = shared_link_login_dto
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/shared-links/login',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
