...
class AuthenticationApi:
    ...
    def logout_o_auth(
        self,
        logout_token: Annotated[StrictStr, Field(description="OAuth logout token")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param logout_token: OAuth logout token (required)
        :type logout_token: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._logout_o_auth_serialize(
    ...
    @validate_call
    def logout_o_auth_with_http_info(
        self,
        logout_token: Annotated[StrictStr, Field(description="OAuth logout token")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def logout_o_auth_without_preload_content(
        self,
        logout_token: Annotated[StrictStr, Field(description="OAuth logout token")],
        _request_timeout: Union[
            None,
    ...
    def _logout_o_auth_serialize(
        ...
        if logout_token is not None:
            _form_params.append(('logout_token', logout_token))
        # process the body parameter
