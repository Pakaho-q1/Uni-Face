...
class PeopleApi:
    ...
    @validate_call
    def delete_people_with_http_info(
        self,
        bulk_ids_dto: BulkIdsDto,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_people_without_preload_content(
        self,
        bulk_ids_dto: BulkIdsDto,
        _request_timeout: Union[
            None,
    ...
    def get_all_people(
        self,
        closest_asset_id: Annotated[Optional[UUID], Field(description="Closest asset ID for similarity search")] = None,
        closest_person_id: Annotated[Optional[UUID], Field(description="Closest person ID for similarity search")] = None,
        page: Annotated[Optional[Annotated[int, Field(le=9007199254740991, strict=True, ge=1)]], Field(description="Page number for pagination")] = None,
        size: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Number of items per page")] = None,
