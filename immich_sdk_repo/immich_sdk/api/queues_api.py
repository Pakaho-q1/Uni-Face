...
class QueuesApi:
    ...
    @validate_call
    def empty_queue_with_http_info(
        self,
        name: QueueName,
        queue_delete_dto: QueueDeleteDto,
        _request_timeout: Union[
    ...
    @validate_call
    def empty_queue_without_preload_content(
        self,
        name: QueueName,
        queue_delete_dto: QueueDeleteDto,
        _request_timeout: Union[
    ...
    def get_queue_jobs(
        self,
        name: QueueName,
        status: Annotated[Optional[List[QueueJobStatus]], Field(description="Filter jobs by status")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    @validate_call
    def get_queue_jobs_with_http_info(
        self,
        name: QueueName,
        status: Annotated[Optional[List[QueueJobStatus]], Field(description="Filter jobs by status")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_queue_jobs_without_preload_content(
        self,
        name: QueueName,
        status: Annotated[Optional[List[QueueJobStatus]], Field(description="Filter jobs by status")] = None,
        _request_timeout: Union[
