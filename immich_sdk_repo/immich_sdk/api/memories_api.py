...
class MemoriesApi:
    ...
    def memories_statistics(
        self,
        var_for: Annotated[Optional[date], Field(description="Filter by date")] = None,
        id: Annotated[Optional[UUID], Field(description="Memory ID")] = None,
        ...
        is_upcoming: Annotated[Optional[StrictBool], Field(description="Filter by memories that have not been shown yet")] = None,
        order: Optional[MemorySearchOrder] = None,
        page: Annotated[Optional[Annotated[int, Field(le=9007199254740991, strict=True, ge=1)]], Field(description="Page number")] = None,
        ...
        :param is_upcoming: Filter by memories that have not been shown yet
        :type is_upcoming: bool
        :param order:
    ...
    def _memories_statistics_serialize(
        ...
        if is_upcoming is not None:
            ...
            _query_params.append(('isUpcoming', is_upcoming))
