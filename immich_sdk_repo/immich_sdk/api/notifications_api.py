...
class NotificationsApi:
    ...
    def get_notifications(
        self,
        id: Annotated[Optional[UUID], Field(description="Filter by notification ID")] = None,
        level: Optional[NotificationLevel] = None,
        type: Optional[NotificationType] = None,
        unread: Annotated[Optional[StrictBool], Field(description="Filter by unread status")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
