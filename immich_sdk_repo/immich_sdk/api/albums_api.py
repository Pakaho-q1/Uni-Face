...
class AlbumsApi:
    ...
    @validate_call
    def add_assets_to_albums_with_http_info(
        self,
        albums_add_assets_dto: AlbumsAddAssetsDto,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def add_assets_to_albums_without_preload_content(
        self,
        albums_add_assets_dto: AlbumsAddAssetsDto,
        _request_timeout: Union[
            None,
    ...
    def get_album_map_markers(
        ...
        _param = self._get_album_map_markers_serialize(
            id=id,
            key=key,
            slug=slug,
            _request_auth=_request_auth,
    ...
    def _get_album_map_markers_serialize(
        self,
        id,
        key,
        slug,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/albums/{id}/map-markers',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_all_albums(
        ...
        :type is_shared: bool
        :param name: Album name (exact match)
        :type name: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def _get_all_albums_serialize(
        ...
        if is_owned is not None:
            ...
            _query_params.append(('isOwned', is_owned))
    ...
    def remove_user_from_album(
        self,
        id: Annotated[UUID, Field(description="Album ID")],
        user_id: Annotated[StrictStr, Field(description="Album user ID, or \"me\" to reference the current user.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: Album ID (required)
        :type id: UUID
        :param user_id: Album user ID, or \"me\" to reference the current user. (required)
        :type user_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
