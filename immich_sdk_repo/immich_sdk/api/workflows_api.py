...
from immich_sdk.api_client import ApiClient, RequestSerialized
from immich_sdk.api_response import ApiResponse
from immich_sdk.rest import RESTResponseType
...
class WorkflowsApi:
    ...
    def get_workflow_for_share(
        ...
        _param = self._get_workflow_for_share_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_workflow_for_share_with_http_info(
        self,
        id: UUID,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[WorkflowShareResponseDto]:
        """Retrieve a workflow
    ...
    @validate_call
    def get_workflow_for_share_without_preload_content(
        self,
        id: UUID,
        _request_timeout: Union[
            None,
    ...
    def _get_workflow_for_share_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/workflows/{id}/share',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_workflow_logs(
        self,
        id: UUID,
        before: Annotated[Optional[datetime], Field(description="Filter by runs before a date/time")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=9007199254740991, strict=True, gt=0)]], Field(description="Maximum number of logs")] = None,
        result: Annotated[Optional[WorkflowResult], Field(description="Filter by run result")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: UUID
        :param before: Filter by runs before a date/time
        :type before: datetime
        :param limit: Maximum number of logs
        :type limit: int
        :param result: Filter by run result
        ...
        _param = self._get_workflow_logs_serialize(
            id=id,
            before=before,
            limit=limit,
            result=result,
    ...
    @validate_call
    def get_workflow_logs_with_http_info(
        self,
        id: UUID,
        before: Annotated[Optional[datetime], Field(description="Filter by runs before a date/time")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=9007199254740991, strict=True, gt=0)]], Field(description="Maximum number of logs")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[WorkflowLogEntryDto]]:
        """Retrieve workflow logs
    ...
    @validate_call
    def get_workflow_logs_without_preload_content(
        self,
        id: UUID,
        before: Annotated[Optional[datetime], Field(description="Filter by runs before a date/time")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=9007199254740991, strict=True, gt=0)]], Field(description="Maximum number of logs")] = None,
    ...
    def _get_workflow_logs_serialize(
        self,
        id,
        before,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/workflows/{id}/logs',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_workflow_triggers(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[WorkflowTriggerResponseDto]:
        ...
        _param = self._get_workflow_triggers_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[WorkflowTriggerResponseDto]",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def get_workflow_triggers_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[WorkflowTriggerResponseDto]]:
        """List all workflow triggers
    ...
    @validate_call
    def get_workflow_triggers_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_workflow_triggers_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/workflows/triggers',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def search_workflows(
        self,
        description: Annotated[Optional[StrictStr], Field(description="Workflow description")] = None,
        enabled: Annotated[Optional[StrictBool], Field(description="Workflow enabled")] = None,
        id: Annotated[Optional[UUID], Field(description="Workflow ID")] = None,
        logging: Annotated[Optional[StrictBool], Field(description="Workflow logs run results")] = None,
        name: Annotated[Optional[StrictStr], Field(description="Workflow name")] = None,
        trigger: Annotated[Optional[WorkflowTrigger], Field(description="Workflow trigger type")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param enabled: Workflow enabled
        :type enabled: bool
        :param id: Workflow ID
        :type id: UUID
        :param logging: Workflow logs run results
        :type logging: bool
        :param name: Workflow name
        :type name: str
        :param trigger: Workflow trigger type
    ...
    def _search_workflows_serialize(
        ...
        if logging is not None:
            ...
            _query_params.append(('logging', logging))
